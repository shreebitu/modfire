        ...
        <footer class="border-t border-white/5 py-10 text-center text-gray-500 mt-auto">
            <div class="max-w-6xl mx-auto px-6">
                <div class="flex flex-wrap justify-center gap-6 text-sm mb-6">
                    ...
                    <a href="${rootPath}upload.html" class="hover:text-white hover:text-indigo-400 transition-colors duration-300">Upload</a>
                    ...
                    <a href="${rootPath}privacy.html" class="hover:text-white hover:text-indigo-400 transition-colors duration-300">Privacy Policy</a>
                </div>
